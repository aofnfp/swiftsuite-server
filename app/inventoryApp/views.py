...
from .tasks import update_inventory_price_quantity_task, map_marketplace_items_to_vendor_task, download_marketplace_items_to_inventory_task, check_ended_status_update_quantity_price_task
        ...
        if serializer.is_valid():
            if market_name == "Ebay":
                ...
                if response == "Success":
                    ...
                    return Response(f"Failed to update product on eBay. {response.text}", status=status.HTTP_400_BAD_REQUEST)
