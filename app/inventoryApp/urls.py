...
urlpatterns = [
    ...
    path('update_item_details_on_marketplace/<int:userid>/<str:market_name>/<int:inventory_id>/', MarketInventory.update_item_on_ebay, name='update_item_details_on_marketplace'),
