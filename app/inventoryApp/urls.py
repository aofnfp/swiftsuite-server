...
urlpatterns = [
    ...
    path('update_item_details_on_marketplace/<int:userid>/<str:market_name>/<int:inventory_id>/', WooCommerceInventory.update_woocommerce_product, name='update_item_details_on_marketplace'),
