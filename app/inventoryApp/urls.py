from .views import MarketInventory as ebview, update_product_on_marketplace
...
urlpatterns = [
    ...
    path('get_all_unmapped_items/<int:userid>/', ebview.get_unmapped_listing_items, name='get_all_unmapped_items'),
