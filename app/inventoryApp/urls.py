from .views import MarketInventory, update_product_on_marketplace, WooCommerceInventory
...
urlpatterns = [
    ...
    path('get_all_unmapped_items/<int:userid>/<int:page_number>/<int:num_per_page>/', MarketInventory.get_unmapped_listing_items, name='get_all_unmapped_items'),
    path('map_inventory_item_to_vendor/<int:userid>/', MarketInventory.map_inventory_item_to_vendor, name='map_inventory_item_to_vendor'),
    path('get_unmapped_items_details/<int:userid>/<int:inventoryid>/', MarketInventory.get_unmapped_product_details, name='get_unmapped_items_details'),
