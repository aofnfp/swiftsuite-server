from .views import OrderEbay as eb_view, OrderSyncView, PlaceOrderView
...
urlpatterns = [
    ...
    path('place_order/<str:market_name>/<str:orderid>/', PlaceOrderView.as_view(), name='place_order'),
